...
class DataSource
{
  static String quote="Don't Fear from COVID-19 ,try to tackle it and take safety measures to prevent yourself from this effect.Use sanitizers ,gloves and masks for best protection.Time to Work smart!";
